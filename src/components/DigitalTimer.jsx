...
const DigitalTimer = () => {
  ...
  return (
    <div className={`group flex items-center gap-2 px-4 py-1.5 rounded-xl border transition-all duration-500
      ${theme === 'ligth'
    ...
    >
      <div className="relative">
        <Clock size={16} className={`transition-colors duration-300 ${theme === 'ligth' ? 'text-blue-600' : 'text-blue-400'} group-hover:rotate-15`} />
